...
| 11. Export the usernames and passwords to a text file.<br>Edit `○○.txt` like this.<br>Identify the hash using tools or [online services](https://hashes.com/en/decrypt/hash).<br>Found hash type: **SHA-256** | <img width="600" height="259" alt="image" src="https://github.com/user-attachments/assets/e0b3126d-f978-428e-be4d-579f4c8761c7" /> |
